...
tcb_ais_rambofactor 			= 	PO3_param_injury_factor;				//	a higher value means more damage tolerance for the unit before the unit are unconcious ( 1== low, 2 == normal, 3 == higher, 5 == extreme)
